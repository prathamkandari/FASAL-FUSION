...
class DecisionTreeClassifier implements Serializable {
    ...
    String predictCrop(double nitrogen, double phosphorus, double potassium, double temp, double humidity, double ph,
            double rain) {
...
public class createModel implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        classifier.saveModel("C:\\Users\\Manav Khandurie\\Downloads\\fasalfusion\\models\\consolemodel.ser");
    }
}