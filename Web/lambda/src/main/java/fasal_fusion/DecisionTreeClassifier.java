...
public class DecisionTreeClassifier implements Serializable {
    ...
    public Node buildTree(String[][] dataset, int currDepth) {
    ...
    public SplitResult getBestSplit(String[][] dataset, int numSamples, int numFeatures) {
    ...
    public SplitResult split(String[][] dataset, int featureIndex, String threshold) {
    ...
    public String predictCrop(double nitrogen, double phosphorus, double potassium, double temp, double humidity, double ph, double rain) {
    ...
    public String makePrediction(String[] x, Node tree) {
        if (tree.value != null) {
